...
happyExpList = Happy_Data_Array.listArray (0,50) ([17280,1024,32768,0,0,192,6144,0,0,0,0,536,8960,34304,12288,32772,33,268,8192,17152,32768,1,12,0,0,0,12288,24584,8,12,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","ExpLet","Exp","Term","Factor","let","num","var","'+'","'-'","'*'","'/'","'('","')'","'='","in","%eof"]
        bit_start = st * 19
        bit_end = (st + 1) * 19
...
happyReduction_1 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Let happy_var_1 happy_var_2 happy_var_3
	) `HappyStk` happyRest
...
happyReduction_9 (HappyTerminal (TokenNum happy_var_1))
	 =  HappyAbsSyn7
		 (Num happy_var_1
	)
